...
# include GDAL
win32:CONFIG(release, debug|release|profile): LIBS += -LC:/gdal/lib/ -lgdal_i
else:win32:CONFIG(debug, debug|release|profile): LIBS += -LC:/gdal/lib/ -lgdal_i
else:win32:CONFIG(profile,debug|release|profile): LIBS += -LC:/gdal/lib/ -lgdal_i
